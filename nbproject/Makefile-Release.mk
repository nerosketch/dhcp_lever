...
${OBJECTDIR}/_ext/180130a8/configs.o: /home/ns/Projects/dhcp_lever/configs.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/180130a8/configs.o /home/ns/Projects/dhcp_lever/configs.cpp

${OBJECTDIR}/http.o: http.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/http.o http.cpp
...
${OBJECTDIR}/regexp.o: regexp.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/regexp.o regexp.cpp

${OBJECTDIR}/sha256.o: sha256.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sha256.o sha256.cpp

${OBJECTDIR}/textUtils.o: textUtils.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/textUtils.o textUtils.cpp
